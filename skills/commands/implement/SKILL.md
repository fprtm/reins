...
Manual entry point to the BUILD phase. Use when a plan/spec/ticket already exists (from `/reins:discover`, `/reins:design`, `/reins:decompose`, or just the current conversation) and it's time to write code.
