...
Detect the project's development methodology and adapt Reins behavior accordingly.
...
Save answer to `docs/reins/memory.md`. Don't ask again.

## Behavior Adaptation

### Scrum

| Reins Component | Adaptation |
|---------------|------------|
