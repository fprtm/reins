...
1. **CLAUDE.md / AGENTS.md** — project-level instructions. These ALWAYS override Reins defaults.
2. **docs/ directory** — architecture docs, design docs, API docs, ADRs.
3. **docs/reins/config.md** — Reins project overrides and saved decisions.
4. **docs/reins/memory.md** — saved project decisions from previous tasks.
