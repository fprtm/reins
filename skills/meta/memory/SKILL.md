...
Save project decisions so Reins doesn't ask the same questions twice.
...
2. Users can manually edit `docs/reins/memory.md`.
...
6. After saving, update `docs/reins/index.md` if memory affects architecture or key conventions.
