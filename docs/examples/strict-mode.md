...
This walkthrough shows Reins in **strict mode** handling a payment-related change.
...
Reins pauses and waits:
```
Plan written to docs/reins/plans/current.md.
...
- `docs/reins/design/payment-refund-fsd.md`
- `docs/reins/design/payment-refund-sdd.md`
- `docs/reins/erd/payment-refund-erd.md` (ERD update with Refund entity)
- `docs/reins/dod/payment-refund-dod.md`
- `docs/reins/test-plans/payment-refund-tests.md`
...
**Decisions logged**: 3 entries in `docs/reins/decisions/`
**Stats**: Full detail in `docs/reins/stats/2026-08.md`
