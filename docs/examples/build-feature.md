# Example: Building a Feature with Reins

This walkthrough shows Reins in **standard mode** handling a medium-sized feature request.
...
Reins writes `docs/reins/plans/current.md`:
...
- `docs/reins/design/user-auth-fsd.md`
- `docs/reins/dod/user-auth-dod.md`
- `docs/reins/test-plans/user-auth-tests.md`
...
**Decision logged**: `docs/reins/decisions/005-jwt-auth-strategy.md`

**Stats footer**:
```
Reins: 1 anti-pattern fixed, 0 security issues, 10 files changed
     Docs generated: FSD, DoD, test plan | Confidence: HIGH | 0 scope deviations
```

**Stats saved**: `docs/reins/stats/2026-08.md`

**Index updated**: `docs/reins/index.md` now links plan → FSD → decisions → report

## Key Takeaways

1. Reins asked 2-3 questions, not 10 — adaptive elicitation
