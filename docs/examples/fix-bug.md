# Example: Fixing a Bug with Reins

This walkthrough shows Reins in **standard mode** handling a bug fix.
...
**Stats footer**:
```
Reins: 0 anti-patterns | 0 security issues | 1 file changed | confidence: HIGH
```
