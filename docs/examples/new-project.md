# Example: Starting a New Project with Reins

This walkthrough shows Reins in **standard mode** setting up a new project from scratch, including architecture proposal.
...
**PRD** (`docs/reins/design/ecommerce-api-prd.md`):
```
...
**ERD** (`docs/reins/erd/ecommerce-erd.md`):
```mermaid
erDiagram
    USER ||--o{ ORDER : places
...
**SDD** (`docs/reins/design/ecommerce-api-sdd.md`):
Architecture decisions, module boundaries, API design patterns.

**DoD** (`docs/reins/dod/ecommerce-api-dod.md`):
...
All artifacts linked in `docs/reins/index.md`:
```
## Documents
- [PRD: E-commerce API](design/ecommerce-api-prd.md)
- [SDD: E-commerce API](design/ecommerce-api-sdd.md)
- [ERD: E-commerce](erd/ecommerce-erd.md)
- [DoD: E-commerce API](dod/ecommerce-api-dod.md)
